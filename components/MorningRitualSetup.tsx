...
// Predefined morning ritual items
const morningRitualOptions = [
  ...
  return (
    <div className="flex flex-col min-h-full justify-between p-6">
      <div className="flex-grow flex flex-col justify-center">
        ...
        <h1 className="text-2xl font-bold text-black mb-2 whitespace-nowrap text-center">Choose 3 morning activities</h1>
        <p className="text-black mb-4 text-center">Select 3 items to include in your morning ritual.</p>
        <p className="text-black mb-8 text-center text-sm">Selected: {selectedItems.size}/3</p>

        <div className="space-y-2 max-h-[400px] overflow-y-auto">
          {morningRitualOptions.map((item) => {
...
export default function MorningRitualSetup() {
  ...
  const handleFinish = (items: RitualItem[]) => {
    ...
    ritualStore.setMorningRitual(ritual);
    goalStore.completeGoal('morning-ritual');
    // XP will be awarded in the reward screen

    dispatch({ type: 'NAVIGATE_TO', payload: 'morning-ritual-reward' });
  };
